      ...
      <div className="border-b border-gray-200 bg-white px-4 md:px-8 py-4">
        <div className="flex items-center gap-4 md:gap-8">
          ...
          <div className="hidden md:block relative">
            ...
            {browseOpen && (
              <div className="absolute top-full left-0 mt-2 w-[640px] border border-black bg-white shadow-none z-50 flex">
                ...
                <div className="w-56 p-6 bg-black text-white flex flex-col justify-between">
                  ...
                  <Link
                    to="/app"
                    className="flex items-center gap-2 text-sm font-semibold text-white hover:text-[#6666FF] transition-colors mt-6"
                  >
                    {t('nav.viewAllAssets')}
          ...
          <div className="hidden md:flex items-center gap-1 ml-auto">
            ...
            <div className="relative">
              <button
                ...
                className="p-2.5 text-black hover:text-[#0000FF] transition-colors"
              ...
              {accountOpen && (
                <div className="absolute top-full right-0 mt-2 w-48 border border-black bg-white z-50">
                  <Link to="/dashboard" className="block px-4 py-3 text-sm text-black hover:bg-gray-100 transition-colors border-b border-gray-200">
                    {t('nav.dashboard')}
                  </Link>
                  <Link to="/auth" className="block px-4 py-3 text-sm text-black hover:bg-gray-100 transition-colors">
                    {t('nav.signIn')}
                  </Link>
                </div>
              )}
